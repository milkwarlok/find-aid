...
public class TraumaLocationReadWriteTest {
    ...
    public void write_TraumaLocation_AndReadInList(){
        Location location = new Location(null, TestUtil.TEST_LOCATION);
        Trauma trauma = new Trauma(null, TestUtil.TEST_TRAUMA, 3);
    ...
    public void write_TraumaLocation_AndReadByLocationId(){
        Location firstLocation = new Location(null, TestUtil.TEST_LOCATION);
        Location secondLocation = new Location(null, TestUtil.TEST_LOCATION);
        mLocationDao.insert(firstLocation, secondLocation);

        Trauma firstTrauma = new Trauma(null, TestUtil.TEST_TRAUMA, 1);
        Trauma secondTrauma = new Trauma(null, TestUtil.TEST_TRAUMA, 2);
